...
if __name__ == "__main__":
    if "copy" in sys.argv[1]:
        ...
        result_addr_info_file = "./linuxRepo/line2addr/result_addr_info.txt"
        cov_raw_folder = "./syzkaller/cov_fodler_vm*"
        print("cp -rf" + path_file + " " + path_source_code_file + " " + syz_comm_content + " " + syz_comm_sig + " " + close_function_file + " " + func2addr_info_file + " " + result_addr_info_file + " " + cov_raw_folder + "  ./experiment_result")
